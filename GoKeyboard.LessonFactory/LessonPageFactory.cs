...
namespace GoKeyboard.LessonFactory
{
    public class LessonPageFactory
    {
        ...
        public OperationResult<GkLesson> BuildPages(GkLesson lesson)
        {
			...
			lesson.LessonPages.Add(CreateAMixedPage(lesson.WorkedChars, 1, 0));

	        string knownCharSet = string.Concat(lesson.WorkedChars, lesson.KnownChars);
